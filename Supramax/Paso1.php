...
<div class="container-fluid">
  <div class="row content">
    ...
    <strong>Tienes que tener en cuenta:</strong> <br>
  <br> * Que el teclado este funcional. </br> 
  <br> * Eschucar los sonidos del pulsador. </br> 
 
   </a>.
  </div>


      <p>  <p><span class="badge">1</span> Levantar palanca donde se realizara la prueba del pulsador Presiona [8]</p><br>
        <p><span class="badge">2</span> Ingresar NIP 566 + [Enter]</p><br>
          <p><span class="badge">3</span> Se envía mensaje Proceso exitoso +[Enter]</p><br>
              <p><span class="badge">4</span> Visualizar  el video del proceso</p><br>
      <br><br>
  ...
  <source src="../Supramax/Videos/Pulsador.mp4"" type="video/mp4">
      </p>
      <hr>
